...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "", // Add sessGifted~VLdlmTLS#loJ2fGKwENU3nCGTGKvDCgNtzbF0KtifiH6rBBpbHrE Id here espwcially when deploying on panels else use app.json and .env file...
...
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "fal) false",

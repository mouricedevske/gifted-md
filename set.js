...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~ICthhQbC#nxrNT24xdhJrcXhKAdSAqkD5GG6_phkiaWkcRhaKVZo", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "94705564619", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "LLW", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "LLW", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "LLW💜", // Added // Input Yours custom...
...
BAD_WORDS: process.env.BAD_WORDS || "fuck, pussy, anus, idiot, hutto", // Add Yours Separated by Comma(will be deleted if ANTIBAD is set to true)
ANTICALL_MSG: process.env.ANTICALL_MSG || "*_📞 Auto Call Reject Mode Active. 📵 No Calls Allowed!_*",
AUTO_REACT: process.env.AUTO_REACT || "false",
BOT_NAME: process.env.BOT_NAME || "LLW", // Input Yours custom...(Maintain font for Flow)
